...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    btnFreeTry.addEventListener("click", (event)=>{
        ...
        modal.addEventListener("click", (event)=>{
            ...
            if (target.classList.contains("modal") || target.classList.contains("modal-close") || target.classList.contains("fa-xmark")) closeModal();
        });
    });
});

},{}]},["2L15i","dV6cC"], "dV6cC", "parcelRequire2fd7")
